            ...
            <div className="md:flex items-center">
                ...
                <div className="text-gray-300 md:w-1/2 text-justify" data-aos="fade-right" data-aos-duration="1000">
                    <p className="text-lg  leading-relaxed opacity-80">
                        Hello, I&#39;m Sabrina Rashid, a passionate junior MERN (MongoDB, Express.js, React, Node.js) developer with a strong interest in web development and emerging technologies.
